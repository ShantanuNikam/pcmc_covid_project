...
pcmc_graph.add_trace(go.Scatter(x=pcmc_data["date"], y=pcmc_data["DAY_WISE_PROGRESSIVE_POSITIVE_COVID_CASES"], fill='tozeroy', mode="lines+markers", name='DAY WISE PROGRESSIVE POSITIVE COVID CASES',
                                marker=dict(
    color="#B5B5B5",
    opacity=0.5,)))
pcmc_graph.add_trace(go.Scatter(x=pcmc_data["date"], y=pcmc_data["DAY_WISE_POSITIVE_COVID_CASES"], fill='tozeroy', mode="lines+markers", name="DAY WISE POSITIVE COVID CASES",
                                marker=dict(
    color="#31A889",
    opacity=0.5,)))  # fill down to xaxis

pcmc_graph.add_trace(go.Scatter(x=pcmc_data["date"], y=pcmc_data["DAY_WISE_RECOVERED_COVID_CASES"], fill='tozeroy', mode="lines+markers", name="DAY WISE RECOVERED COVID CASES",
                                marker=dict(
    color="#ED708B",
    opacity=0.5,)))
...
# --------------------------------------- dummy ----------------------
pcmc = go.Figure()
pcmc.add_trace(go.Scatter(x=pcmc_data["date"], y=pcmc_data["DAY_WISE_PROGRESSIVE_POSITIVE_COVID_CASES"], fill='tozeroy', mode="lines+markers", name='DAY WISE PROGRESSIVE POSITIVE COVID CASES',
                          marker=dict(
    color="#B5B5B5",
    opacity=0.5,)))
...
pcmc_pos_rec.add_trace(go.Scatter(x=pcmc_data["date"], y=pcmc_data["DAY_WISE_POSITIVE_COVID_CASES"], fill='tozeroy', mode="lines+markers", name="DAY WISE POSITIVE COVID CASES",
                                  marker=dict(
    color="#d7385e",
    opacity=0.5,)))  # fill down to xaxis

pcmc_pos_rec.add_trace(go.Scatter(x=pcmc_data["date"], y=pcmc_data["DAY_WISE_RECOVERED_COVID_CASES"], fill='tozeroy', mode="lines+markers", name="DAY WISE RECOVERED COVID CASES",
                                  marker=dict(
    color="#f6830f",
    opacity=0.5,)))
