...
s_row1 = html.Tr(html.Td(
    "Most common symptoms:fever,dry cough,tiredness", className="s_row"))
s_row2 = html.Tr(html.Td("Less common symptoms: aches and pains,sore throat,diarrhoea,conjunctivitis,headache,loss of taste or smella rash on skin, or discolouration of fingers or toes", className="s_row"))
s_row3 = html.Tr(html.Td("Serious symptoms:difficulty breathing or shortness of breath, chest pain or pressure ,loss of speech or movement", className="s_row"))
