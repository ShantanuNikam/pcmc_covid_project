    ...
    html.Div([
        html.Div([
            html.P(["last update on : ", html.Span("20 sept")],
                   style={'color': "#ffffff"}),
            dbc.Row([
                dbc.Col(html.Div([html.H3(70140), html.P("Total Positive Cases")],
                                 className="main_div", style={"backgroundColor": "#8B0000"})),
                dbc.Col(html.Div([html.H3(421), html.P("Today's Positive")],
                                 className="main_div", style={"backgroundColor": "#00CED1"})),
                dbc.Col(html.Div([html.H3(963), html.P("Today's Discharged")],
                                 className="main_div", style={"backgroundColor": "#0000FF"})),
            ]),
            dbc.Row([
                dbc.Col(html.Div([html.H3(7520), html.P("Active Cases")],
                                 className="main_div", style={"backgroundColor": "	#FFA500"})),
                dbc.Col(html.Div([html.H3(61848), html.P("Recovered")],
                                 className="main_div", style={"backgroundColor": "	#008000"})),
